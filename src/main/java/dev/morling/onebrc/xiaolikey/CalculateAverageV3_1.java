...
public class CalculateAverageV3_1 {
    ...
    private static final int STATION_CAPACITY = 100000;
    ...
    private static class StationMap {
         ...
         * @return 索引
         */
        public int getIndex(StationStatistics newRecord) {
            int hash = newRecord.hashCode;
            int slot = (hash ^ (hash >>> 16)) & (STATION_CAPACITY - 1);
            while (stations[slot] != null && !stations[slot].equals(newRecord)) {
                slot++;
