 ...
 *  <href =https://github.com/gunnarmorling/1brc/blob/main/src/main/java/dev/morling/onebrc/CalculateAverage_thomaswue.java />
 */
public class CalculateAverage_first {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        try (var fileChannel = FileChannel.open(java.nio.file.Path.of(FILE), java.nio.file.StandardOpenOption.READ)) {
            ...
            System.out.close();
            //输出本地文件，用于产生基准结构
            Path outPath = Paths.get("./result_first.txt");
            try(PrintStream out = new PrintStream(Files.newOutputStream(outPath, StandardOpenOption.CREATE, StandardOpenOption.TRUNCATE_EXISTING))){
                out.println(accumulateResults(allResults));
            }
        }
    }
